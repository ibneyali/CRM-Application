	...
	<div class="top">
		<div class="container">
			<div class="row">
				<div class="span6">
					<p class="topcontact">
						<i class="icon-phone"></i> +91 798 300 8211
					</p>
				</div>
				<div class="span6">

					<ul class="social-network">
						<li><a href="http://www.facebook.com/ali.ias/" data-placement="bottom" title="Facebook"><i
								class="icon-facebook icon-white"></i></a></li>
						<li><a href="http://www.twitter.com/ibney_ali" data-placement="bottom" title="Twitter"><i
								class="icon-twitter icon-white"></i></a></li>
						<li><a href="http://www.linkedin.com/in/ibney-ali" data-placement="bottom" title="Linkedin"><i
