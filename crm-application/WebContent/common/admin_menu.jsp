...
<nav>
	<ul class="nav topnav">
		...
		<li class="dropdown"><a href="#"><%=resource.getString("admin.add") %> <i class="icon-angle-down"></i></a>
			...
			<li class="dropdown"><a href="#"><%=resource.getString("admin.enroll") %><i class="icon-angle-down"></i></a>
			<ul class="dropdown-menu">
